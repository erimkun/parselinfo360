...
const Card = ({ children, title, icon: Icon, cols = "col-span-1" }: CardProps) => (
    <div className={`bg-white dark:bg-slate-800/50 rounded-2xl p-3 sm:p-5 border border-gray-200 dark:border-white/10 shadow-sm backdrop-blur-sm ${cols}`}>
        <h3 className="text-xs sm:text-sm font-bold text-gray-700 dark:text-gray-200 uppercase mb-3 sm:mb-4 flex items-center gap-2 border-b border-gray-100 dark:border-white/10 pb-2">
...
export const MarketIndexView: React.FC = () => {
    ...
    return (
        <div className="h-full overflow-y-auto overflow-x-hidden custom-scrollbar p-3 sm:p-6 space-y-4 sm:space-y-6 pb-24">
            <div className="flex items-center justify-between mb-2 flex-wrap gap-2">
                ...
                <span className="text-[10px] sm:text-xs bg-indigo-100 dark:bg-indigo-900 text-indigo-800 dark:text-indigo-200 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full font-bold">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                ...
                <Card title={
                    ...
                    {/* Chart Area */}
                    <div className="h-56 sm:h-72 w-full mb-4 sm:mb-6 relative z-0">
                        <ResponsiveContainer>
                            <AreaChart data={
                    ...
                    <div className="flex justify-center border-t border-gray-100 dark:border-gray-800 pt-3 sm:pt-4">
                        <div className="flex gap-2 sm:gap-4">
                            <button
                                onClick={() => setSlideIndex(0)}
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-full text-[10px] sm:text-xs font-bold transition-all ${slideIndex === 0
                            ...
                            <button
                                ...
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-full text-[10px] sm:text-xs font-bold transition-all ${slideIndex === 1
                                    ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30'
                                    : 'bg-white text-gray-500 hover:bg-gray-50 border border-gray-200'}`}
                            >
                                2. İlan
                            ...
                            <button
                                ...
                                className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-full text-[10px] sm:text-xs font-bold transition-all ${slideIndex === 2
                                    ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-500/30'
                                    : 'bg-white text-gray-500 hover:bg-gray-50 border border-gray-200'}`}
                            >
                                3. Derinlik
