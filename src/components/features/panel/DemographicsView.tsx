...
export const DemographicsView: React.FC = () => {
    ...
    return (
        <div className="h-full overflow-y-auto custom-scrollbar pr-2 space-y-4 sm:space-y-6 pb-20 pt-4" style={{ overflow: 'visible' }}>

            {/* KPIs Grid */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3">
                <div className="bg-purple-500/10 p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-purple-500/20 backdrop-blur-sm text-center transform hover:scale-[1.02] transition-all duration-300">
                    <Users className="w-4 h-4 sm:w-5 sm:h-5 text-purple-500 mx-auto mb-1" />
                    <div className="text-lg sm:text-xl font-black text-gray-900 dark:text-white">{stats.totalPop}</div>
                    <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-gray-500 font-bold">Nüfus</div>
                </div>
                <div className="bg-blue-500/10 p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-blue-500/20 backdrop-blur-sm text-center transform hover:scale-[1.02] transition-all duration-300">
                    <Home className="w-4 h-4 sm:w-5 sm:h-5 text-blue-500 mx-auto mb-1" />
                    <div className="text-lg sm:text-xl font-black text-gray-900 dark:text-white">{stats.avgHousehold}</div>
                    <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-gray-500 font-bold">Hane Büyüklüğü</div>
                </div>
                <div className="bg-emerald-500/10 p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-emerald-500/20 backdrop-blur-sm text-center transform hover:scale-[1.02] transition-all duration-300">
                    <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-500 mx-auto mb-1" />
                    <div className="text-lg sm:text-xl font-black text-gray-900 dark:text-white">{stats.avgDensity}</div>
                    <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-gray-500 font-bold">Yoğunluk (k/ha)</div>
                </div>
                <div className="bg-amber-500/10 p-2 sm:p-3 rounded-xl sm:rounded-2xl border border-amber-500/20 backdrop-blur-sm text-center transform hover:scale-[1.02] transition-all duration-300">
                    <TrendingUp className="w-4 h-4 sm:w-5 sm:h-5 text-amber-500 mx-auto mb-1" />
                    <div className="text-lg sm:text-xl font-black text-gray-900 dark:text-white">{stats.sesScore}</div>
                    <div className="text-[9px] sm:text-[10px] uppercase tracking-wider text-gray-500 font-bold">SES Skoru</div>
                </div>
            </div>

            {/* Gender Balance – Diverging 100% bar chart */}
            <div className="bg-white dark:bg-white/5 rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-gray-200 dark:border-white/10 shadow-sm relative z-50">
                <h4 className="text-[10px] sm:text-xs font-bold text-gray-500 uppercase mb-2 sm:mb-3 flex items-center gap-2">
                    <Users className="w-3 h-3 sm:w-4 sm:h-4" /> Cinsiyet Dengesi
                </h4>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div className="bg-white dark:bg-white/5 rounded-2xl p-3 sm:p-4 border border-gray-200 dark:border-white/10 shadow-sm backdrop-blur-sm relative z-50">
                    <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 sm:mb-4">Yaş Dağılımı</h4>
                ...
                <div className="bg-white dark:bg-white/5 rounded-2xl p-3 sm:p-4 border border-gray-200 dark:border-white/10 shadow-sm backdrop-blur-sm relative z-50">
                    <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 sm:mb-4 flex items-center gap-2">
                ...
                {/* Education Donut */}
                <div className="bg-white dark:bg-white/5 rounded-2xl p-3 sm:p-4 border border-gray-200 dark:border-white/10 shadow-md relative z-50">
                    <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 sm:mb-4">Eğitim Durumu</h4>
                ...
                {/* Marital Donut */}
                <div className="bg-white dark:bg-white/5 rounded-2xl p-3 sm:p-4 border border-gray-200 dark:border-white/10 shadow-md relative z-50">
                    <h4 className="text-xs font-bold text-gray-500 uppercase mb-3 sm:mb-4">Medeni Durum</h4>
                    <div className="h-48 sm:h-64 flex flex-col items-center justify-center">
                        <ResponsiveContainer width="100%" height={140} className="sm:!h-[180px]">
                            <PieChart>
                                <Pie
