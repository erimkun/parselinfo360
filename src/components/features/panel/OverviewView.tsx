...
export const OverviewView: React.FC = () => {
    ...
    return (
        <div className="space-y-6 h-full overflow-y-auto custom-scrollbar pr-2">
            ...
            <div className="relative h-36 sm:h-48 rounded-2xl overflow-hidden shadow-2xl border border-gray-200 dark:border-white/10 group">
            ...
            <div className="grid grid-cols-2 gap-2 sm:gap-3">
                <div className="bg-blue-500/10 dark:bg-blue-500/10 p-3 sm:p-4 rounded-xl border border-blue-500/20 shadow-lg backdrop-blur-md hover:bg-blue-500/15 transition-all group">
                ...
                <div className="bg-green-500/10 dark:bg-green-500/10 p-3 sm:p-4 rounded-xl border border-green-500/20 shadow-lg backdrop-blur-md hover:bg-green-500/15 transition-all group">
                    <div className="flex items-center gap-2 mb-2">
                ...
                <div className="bg-purple-500/10 dark:bg-purple-500/10 p-3 sm:p-4 rounded-xl border border-purple-500/20 shadow-lg backdrop-blur-md hover:bg-purple-500/15 transition-all group">
                    <div className="flex items-center gap-2 mb-2">
                ...
                <div className="bg-orange-500/10 dark:bg-orange-500/10 p-3 sm:p-4 rounded-xl border border-orange-500/20 shadow-lg backdrop-blur-md hover:bg-orange-500/15 transition-all group">
                    <div className="flex items-center gap-2 mb-2">
            ...
            {/* Description */}
            <div className="bg-white dark:bg-gray-800/50 p-3 sm:p-5 rounded-2xl border border-gray-200 dark:border-gray-700 shadow-sm transition-all overflow-hidden relative">
            ...
            {/* Parse Info */}
            <div className="bg-blue-50 dark:bg-blue-900/10 p-3 sm:p-5 rounded-2xl border border-blue-100 dark:border-blue-800/50 shadow-sm">
                <h3 className="font-bold text-blue-900 dark:text-blue-100 mb-3 sm:mb-4 text-xs sm:text-sm flex items-center justify-between">
                    Parsel Bilgileri
