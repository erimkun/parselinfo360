...
export const FloatingStrategyPanel: React.FC = () => {
    ...
    return (
        <div className="absolute bottom-20 right-4 sm:bottom-8 sm:right-8 z-[1000] flex flex-col items-end pointer-events-none">
            ...
            <AnimatePresence mode="wait">
                {!isOpen ? (
                    ...
                    <motion.button
                        ...
                        className="pointer-events-auto flex items-center gap-2 sm:gap-3 px-4 py-3 sm:px-6 sm:py-4 rounded-full bg-white/10 dark:bg-slate-900/15 text-gray-900 dark:text-white shadow-lg border border-white/20 dark:border-white/10 backdrop-blur-xl hover:bg-white/20 dark:hover:bg-slate-800/25 transition-all group"
                    >
                        <div className="relative">
                            <BrainCircuit size={18} className="sm:w-[22px] sm:h-[22px] text-blue-300 group-hover:text-white transition-colors" />
                            <span className="absolute -top-1 -right-1 w-2.5 h-2.5 sm:w-3 sm:h-3 bg-green-500 rounded-full animate-pulse border-2 border-slate-900 shadow-[0_0_10px_rgba(74,222,128,0.8)]"></span>
                        </div>
                        <div className="flex flex-col items-start leading-none gap-0.5">
                            <span className="text-[9px] sm:text-[11px] text-blue-600 dark:text-blue-200 font-bold font-mono tracking-widest uppercase">AI</span>
                            <span className="font-bold text-xs sm:text-sm tracking-wide text-gray-900 dark:text-white drop-shadow-sm">Analiz</span>
                        </div>
                    </motion.button>
                ) : (
                    ...
                    <motion.div
                        ...
                        className="pointer-events-auto w-[calc(100vw-2rem)] sm:w-[380px] lg:w-[420px] bg-white/10 dark:bg-slate-900/15 backdrop-blur-xl border border-white/15 dark:border-white/10 rounded-2xl lg:rounded-3xl shadow-xl overflow-hidden flex flex-col relative max-h-[60vh] sm:max-h-none"
                    >
